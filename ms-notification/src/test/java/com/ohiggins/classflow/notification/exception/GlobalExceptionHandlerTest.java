...
class GlobalExceptionHandlerTest {
    ...
    void testHandleRuntimeException() {
        ...
        RuntimeException ex = new RuntimeException("Notificación no encontrada");
        ...
        assertThat(response.getBody().getMessage()).isEqualTo("Notificación no encontrada");
    ...
    void testHandleGenericException() {
        when(request.getRequestURI()).thenReturn("/api/notifications/pending");
        Exception ex = new Exception("Error de conexión");
