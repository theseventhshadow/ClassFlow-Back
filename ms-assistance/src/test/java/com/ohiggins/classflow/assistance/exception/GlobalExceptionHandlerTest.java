...
class GlobalExceptionHandlerTest {
    ...
    @Test
    @DisplayName("Should handle RuntimeException and return 400 with path")
    void testHandleRuntimeException() {
        when(request.getRequestURI()).thenReturn("/api/attendance");
    ...
    void testHandleGenericException() {
        when(request.getRequestURI()).thenReturn("/api/annotations");
