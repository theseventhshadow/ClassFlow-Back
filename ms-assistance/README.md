...
docker build -t ms-assistance:local .
docker run -p 8083:8083 -e SPRING_PROFILES_ACTIVE=docker ms-assistance:local
```
...
- **"Student not found"**: Verificar que el estudiante existe (integración con ms-auth)
