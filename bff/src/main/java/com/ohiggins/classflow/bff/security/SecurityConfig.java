package com.ohiggins.classflow.bff.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.ohiggins.classflow.bff.exception.ErrorResponse;
 ...
 * microservicios MVC). El bff no tiene rutas de negocio publicas: todo /api/bff/**
...
public class SecurityConfig {
    ...
    public SecurityConfig(@Value("${services.auth.base-url}") String authServiceUrl, ObjectMapper objectMapper) {
