package com.ohiggins.classflow.message.exception;
...
class GlobalExceptionHandlerTest {
    ...
    void testHandleRuntimeException() {
        ...
        RuntimeException ex = new RuntimeException("Error al enviar mensaje");
        ...
        assertThat(response.getBody().getMessage()).isEqualTo("Error al enviar mensaje");
    ...
    void testHandleGenericException() {
        when(request.getRequestURI()).thenReturn("/api/announcements");
